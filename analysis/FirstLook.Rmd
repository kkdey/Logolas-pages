...
We have shown an example of multipanel Logolas plots above. Logolas plots can be combined with ggplot2 graphics in a very similar fashion.  We show such an example below.
