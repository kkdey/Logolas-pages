...
GetMotif=function(pwm,seqmotif,bg=NULL){
  ...
  ll=get_logo_heights_log(pwm,depletion_weight = 0,epsilon = 0.01,bg=bg)
...
#nlogomaker(pwm,logoheight = 'log',color_profile = color_profile,frame_width = 1,control = list(depletion_weight=0))
```
