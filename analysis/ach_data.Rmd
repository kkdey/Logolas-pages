---
title: "Dash combined dash examples"
author: "Kushal K Dey"
date: "10/4/2017"
...
Ach=plantTF("../data/Ach")
```


```{r,echo=FALSE,message=FALSE,fig.width=35,fig.height=30}
grid.newpage()
layout.rows <- 6
layout.cols <- 2
...
Ach1=plantTF("../data/Ach",bgs='uniform')
