...
#'
#' @description Genertes total heights of the logos in the positive
#' and negative scales of the nlogomaker() logo plot along with the
#' proportion of the height distributed between the logos to be
#' plotted in the positive and the negative scales respectively.
#'
#' @param table The input table (data frame or matrix) of counts
#' across different logos or symbols (specified along the rows) ans
#' across different sites or positions or groups (specified along the
#' columns).
#'
#' @param epsilon An additive constant added to the PWM before scaling
#' to eliminate log (0) type errors.
#'
#' @param bg The background probability, which defaults to NULL, in
#' which case equal probability is assigned to each symbol. The user
