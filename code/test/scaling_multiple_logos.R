...
###############  height normalizer   (Logolas)  ###################


#########  how to keep the same range for multiple Logolas plots  ###########
...
nlogomaker(table[,2:4],
           ...
           control = list(epsilon=0.25,gap_ylab=3.5,
                          round_off = 1, lowrange = 1.5,
                          uprange = 3, size_port = 2)
)


nlogomaker(bgtable[,2:4],
           logoheight = 'log',
           color_profile = color_profile,
           frame_width = c(1,2,1),
           xlab = "Position",
